...
namespace iJedha.Automation.EAP.WebAPI
{
    public partial class WebAPIReport : BaseComm
    {
        ...
        public void EAP_UnLoadComplete(MessageModel.UnLoadComplete _data, EquipmentModel em, int Retrytime)
        {
            ...
            try
            {
                ...
                if (returnInfo.strCode != "0000")
                {
                    ...
                    EAP.Environment.BaseComm.ErrorHandleRule("E3006", errMsg, ref errm);
                }
            }
            catch (Exception e)
            {
                ...
                if (e.Message.ToString() == ConstLibrary.CONST_WEBAPI_TIMEOUT_KEYWORD)
                {
                    ...
                    {
                        Retrytime++;
                        EAP_UnLoadComplete(_data, em, Retrytime);
                    }
                    else
                    {
