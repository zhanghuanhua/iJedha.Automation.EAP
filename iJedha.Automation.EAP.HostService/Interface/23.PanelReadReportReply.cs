...
namespace iJedha.Automation.EAP.HostService
{
    public partial class HostService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool PanelReadReportReply(string transactionId, string eqpID)
        {
            bool rtn = false;

            try
            {
                SocketMessageStructure.PanelReadReportReply msg = new SocketMessageStructure.PanelReadReportReply();
                msg.HEADER.MESSAGENAME = eSocketCommand.PanelReadReportReply.GetEnumDescription();
