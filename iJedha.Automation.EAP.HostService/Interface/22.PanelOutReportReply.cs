...
namespace iJedha.Automation.EAP.HostService
{
    public partial class HostService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool PanelOutReportReply(string transactionId, string eqpID)
        {
            bool rtn = false;

            try
            {
                SocketMessageStructure.PanelOutReportReply msg = new SocketMessageStructure.PanelOutReportReply();
                msg.HEADER.MESSAGENAME = eSocketCommand.PanelOutReportReply.GetEnumDescription();
