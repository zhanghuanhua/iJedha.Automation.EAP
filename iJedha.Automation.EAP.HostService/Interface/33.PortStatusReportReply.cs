...
namespace iJedha.Automation.EAP.HostService
{
    public partial class HostService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool PortStatusReportReply(string transactionId, string eqpID)
        {
            bool rtn = false;

            try
            {
                SocketMessageStructure.PortStatusReportReply msg = new SocketMessageStructure.PortStatusReportReply();
                msg.HEADER.MESSAGENAME = eSocketCommand.PortStatusReportReply.GetEnumDescription();
