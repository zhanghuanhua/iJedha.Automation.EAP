...
namespace iJedha.Automation.EAP.HostService
{
    public partial class HostService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool EquipmentCurrentRecipeReply(string transactionId, string eqpID)
        {
            bool rtn = false;

            try
            {
                SocketMessageStructure.EquipmentCurrentRecipeReply msg = new SocketMessageStructure.EquipmentCurrentRecipeReply();
                msg.HEADER.MESSAGENAME = eSocketCommand.EquipmentCurrentRecipeReply.GetEnumDescription();
