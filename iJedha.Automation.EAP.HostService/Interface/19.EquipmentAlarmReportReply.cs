...
namespace iJedha.Automation.EAP.HostService
{
    public partial class HostService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool EquipmentAlarmReportReply(string transactionId, string eqpID)
        {
            bool rtn = false;

            try
            {
                SocketMessageStructure.EquipmentAlarmReportReply msg = new SocketMessageStructure.EquipmentAlarmReportReply();
                msg.HEADER.MESSAGENAME = eSocketCommand.EquipmentAlarmReportReply.GetEnumDescription();
