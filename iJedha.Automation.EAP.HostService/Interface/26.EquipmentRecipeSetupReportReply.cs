...
namespace iJedha.Automation.EAP.HostService
{
    public partial class HostService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool EquipmentRecipeSetupReportReply(string transactionId, string eqpID)
        {
            bool rtn = false;

            try
            {
                SocketMessageStructure.EquipmentRecipeSetupReportReply msg = new SocketMessageStructure.EquipmentRecipeSetupReportReply();
                msg.HEADER.MESSAGENAME = eSocketCommand.EquipmentRecipeSetupReportReply.GetEnumDescription();
