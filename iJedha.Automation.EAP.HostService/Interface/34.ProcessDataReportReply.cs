...
namespace iJedha.Automation.EAP.HostService
{
    public partial class HostService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool ProcessDataReportReply(string transactionId, string eqpID)
        {
            bool rtn = false;

            try
            {
                SocketMessageStructure.ProcessDataReportReply msg = new SocketMessageStructure.ProcessDataReportReply();
                msg.HEADER.MESSAGENAME = eSocketCommand.ProcessDataReportReply.GetEnumDescription();
