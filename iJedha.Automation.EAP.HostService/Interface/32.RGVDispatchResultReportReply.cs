...
namespace iJedha.Automation.EAP.HostService
{
    public partial class HostService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool RGVDispatchResultReportReply(string transactionId, string eqpID)
        {
            bool rtn = false;

            try
            {
                SocketMessageStructure.RGVDispatchResultReportReply msg = new SocketMessageStructure.RGVDispatchResultReportReply();
                msg.HEADER.MESSAGENAME = eSocketCommand.RGVDispatchResultReportReply.GetEnumDescription();
