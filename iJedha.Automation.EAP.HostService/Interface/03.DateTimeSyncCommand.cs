...
namespace iJedha.Automation.EAP.HostService
{
    public partial class HostService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public void DateTimeSyncCommand( string eqpID)
        {

            try
            {
                SocketMessageStructure.DateTimeSyncCommand msg = new SocketMessageStructure.DateTimeSyncCommand();
                msg.HEADER.MESSAGENAME = eSocketCommand.DateTimeSyncCommand.GetEnumDescription();
                msg.HEADER.TRANSACTIONID = DateTime.Now.ToString("yyyyMMddHHmmssfff");
                msg.BODY.eqp_id = eqpID;
                msg.BODY.date_time= DateTime.Now.ToString("yyyyMMddHHmmss");
