...
namespace iJedha.Automation.EAP.HostService
{
    public partial class HostService
    {
        ...
        /// <returns></returns>
        public static bool EquipmentControlModeReply(string transactionId, string eqpID)
        {
            bool rtn = false;

            try
            {
                SocketMessageStructure.EquipmentControlModeReply msg = new SocketMessageStructure.EquipmentControlModeReply();
                msg.HEADER.MESSAGENAME = eSocketCommand.EquipmentControlModeReply.GetEnumDescription();
