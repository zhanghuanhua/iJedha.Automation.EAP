...
namespace iJedha.Automation.EAP.HostService
{
    public partial class HostService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool CarrierReadReportReply(string transactionId, string eqpID)
        {
            bool rtn = false;

            try
            {
                SocketMessageStructure.CarrierReadReportReply msg = new SocketMessageStructure.CarrierReadReportReply();
                msg.HEADER.MESSAGENAME = eSocketCommand.CarrierReadReportReply.GetEnumDescription();
