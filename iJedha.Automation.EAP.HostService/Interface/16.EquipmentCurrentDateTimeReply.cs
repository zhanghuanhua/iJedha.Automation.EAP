...
namespace iJedha.Automation.EAP.HostService
{
    public partial class HostService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool EquipmentCurrentDateTimeReply(string transactionId, string eqpID)
        {
            bool rtn = false;

            try
            {
                SocketMessageStructure.EquipmentCurrentDateTimeReply msg = new SocketMessageStructure.EquipmentCurrentDateTimeReply();
                msg.HEADER.MESSAGENAME = eSocketCommand.EquipmentCurrentDateTimeReply.GetEnumDescription();
