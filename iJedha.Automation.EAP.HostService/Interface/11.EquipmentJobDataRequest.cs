...
namespace iJedha.Automation.EAP.HostService
{
    public partial class HostService
    {
        ...
        public void EquipmentJobDataRequest( string eqpID)
        {
            ...
            try
            {
                ...
                if (em == null)
                {
                    BaseComm.LogMsg(Log.LogLevel.Error, string.Format("Equipment ID<{0}> Function Name<EquipmentJobDataRequest> Find Error", eqpID));
                    return;
                }
                #region 连线检查
                ...
                #endregion
                SocketMessageStructure.EquipmentJobDataRequest msg = new SocketMessageStructure.EquipmentJobDataRequest();

                msg.HEADER.MESSAGENAME = eSocketCommand.EquipmentJobDataRequest.GetEnumDescription();
