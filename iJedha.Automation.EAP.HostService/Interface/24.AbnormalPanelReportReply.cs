...
namespace iJedha.Automation.EAP.HostService
{
    ...
    {
        public static bool AbnormalPanelReportReply(string transactionId, string eqpID)
        {
            bool rtn = false;
            try
            {
                SocketMessageStructure.AbnormalPanelReportReply msg = new SocketMessageStructure.AbnormalPanelReportReply();
                msg.HEADER.MESSAGENAME = eSocketCommand.AbnormalPanelReportReply.GetEnumDescription();
