...
namespace iJedha.Automation.EAP.HostService
{
    public partial class HostService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool EquipmentCurrentStatusReply(string transactionId, string eqpID)
        {
            bool rtn = false;

            try
            {
                SocketMessageStructure.EquipmentCurrentStatusReply msg = new SocketMessageStructure.EquipmentCurrentStatusReply();
                msg.HEADER.MESSAGENAME = eSocketCommand.EquipmentCurrentStatusReply.GetEnumDescription();
