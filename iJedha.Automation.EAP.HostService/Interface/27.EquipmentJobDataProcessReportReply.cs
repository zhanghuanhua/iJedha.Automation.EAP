...
namespace iJedha.Automation.EAP.HostService
{
    public partial class HostService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool EquipmentJobDataProcessReportReply(string transactionId, string eqpID)
        {
            bool rtn = false;

            try
            {
                SocketMessageStructure.EquipmentJobDataProcessReportReply msg = new SocketMessageStructure.EquipmentJobDataProcessReportReply();
                msg.HEADER.MESSAGENAME = eSocketCommand.EquipmentJobDataProcessReportReply.GetEnumDescription();
