...
namespace iJedha.Automation.EAP.HostService
{
    public partial class HostService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool TrayStatusReportReply(string transactionId, string eqpID)
        {
            bool rtn = false;

            try
            {
                SocketMessageStructure.TrayStatusReportReply msg = new SocketMessageStructure.TrayStatusReportReply();
                msg.HEADER.MESSAGENAME = eSocketCommand.TrayStatusReportReply.GetEnumDescription();
