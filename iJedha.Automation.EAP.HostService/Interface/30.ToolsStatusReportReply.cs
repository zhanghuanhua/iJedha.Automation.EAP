...
namespace iJedha.Automation.EAP.HostService
{
    public partial class HostService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool ToolsStatusReportReply(string transactionId, string eqpID)
        {
            bool rtn = false;

            try
            {
                SocketMessageStructure.ToolsStatusReportReply msg = new SocketMessageStructure.ToolsStatusReportReply();
                msg.HEADER.MESSAGENAME = eSocketCommand.ToolsStatusReportReply.GetEnumDescription();
