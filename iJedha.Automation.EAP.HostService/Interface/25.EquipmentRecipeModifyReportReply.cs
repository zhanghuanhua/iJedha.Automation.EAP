...
namespace iJedha.Automation.EAP.HostService
{
    public partial class HostService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool RecipeModifyReportReply(string transactionId, string eqpID)
        {
            bool rtn = false;

            try
            {
                SocketMessageStructure.RecipeModifyReportReply msg = new SocketMessageStructure.RecipeModifyReportReply();
                msg.HEADER.MESSAGENAME = eSocketCommand.RecipeModifyReportReply.GetEnumDescription();
