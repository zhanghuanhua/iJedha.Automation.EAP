...
namespace iJedha.Automation.EAP.HostService
{
    public partial class HostService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool EquipmentOperationModeReply(string transactionId, string eqpID)
        {
            bool rtn = false;

            string operationMode = string.Empty;//TBD

            try
            {
                SocketMessageStructure.EquipmentOperationModeReply msg = new SocketMessageStructure.EquipmentOperationModeReply();
                msg.HEADER.MESSAGENAME = eSocketCommand.EquipmentOperationModeReply.GetEnumDescription();
