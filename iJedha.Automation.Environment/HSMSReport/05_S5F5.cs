...
namespace iJedha.Automation.EAP.Environment
{
    public partial class HSMSReport
    {
        ...
        public void S5F5(EquipmentModel em, string alarms, uint SysBytes = 0)
        {
            try
            {
                ...
                TS5F5 SxFy = new TS5F5();
                SxFy.ALIDs = alarms;
                SxFy.ALIDsTYPE = EAPEnvironment.commonLibrary.equipmentLibary.GetVariableIDType(em.EQID, eVariableID.ALIDs.ToString());
